...
1. 使用 Unity Hub 添加项目。
2. 选择项目根目录。
3. 使用 Unity 2022.3 LTS 打开。
4. 第一次打开会重新生成 Library，等待导入完成。
5. 从主菜单场景启动游戏。
...
当前版本已经具备弓箭传说类 Demo 的核心玩法闭环：

```text
主菜单 -> 开始游戏 -> 摇杆移动 -> 停止自动攻击 -> 击杀敌人 -> 获得经验 -> 升级强化 -> 清空房间 -> 进入下一关
```

后续可以继续扩展更多敌人类型、更多房间、更多技能强化、Boss 战和更完整的关卡流程。
